            ...
            [
                html.Div(
                    [
                        ...
                        html.H1("Enfermedad cardiaca: analisis y Random Forest"),
                        html.P(
                            "Explora el conjunto de datos, filtra cohortes y prueba un "
                            "clasificador Random Forest integrado en la misma pagina."
                        ),
                    ],
                    className="hero-copy",
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Dropdown(
                                    id="numeric-column",
                                    options=[{"label": label_for(c), "value": c} for c in NUMERIC_COLUMNS],
                                    value="chol",
                                    clearable=False,
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Dropdown(
                                    id="category-column",
                                    options=[{"label": label_for(c), "value": c} for c in CATEGORICAL_COLUMNS],
                                    value="cp",
                                    clearable=False,
                                ),
                            ],
